...
6. You could $\color{#B24745FF}{\text{specify/underline a sample or multiple samples}}$ on the figure by clicking the corresponding row on the table. Click the row once again to cancel the specification. 
7. Type in a keyword in the $\color{#B24745FF}{\text{search}}$ field to search for a certain information. 
8. Click on the $\color{#B24745FF}{\text{Download figure/table}}$ button to download the results to your local devices to view them offline.
9. While navigating to a new disease type, a popup dialog with the text "If you choose to continue, the current input file and the results will be cleared. Please download the results beforehand if you prefer to keep a record." will appear. If the user choose to $\color{#B24745FF}{\text{continue}}$, the application will clear all current data and switch to the corresponding model.
