...
6. A $\color{#B24745FF}{\text{suggested sensitivity cutoff}}$ is used by default for deciding true/false positives in the first calculation. The sensitivity cutoff is $\color{#B24745FF}{\text{customizable}}$ with the slider bar on the left-side panel.
