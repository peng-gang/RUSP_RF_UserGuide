...
The current model is based on the data from California. Because of the difference of NBS project between different states, the model may not fit the data out side of California. Please contact [us](mailto:gang.peng@yale.edu) if you want to include model from your state. 
