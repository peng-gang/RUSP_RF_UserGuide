...
While navigating to a new disease type, the application will clear current result and switch to the corresponding model. Please download the results beforehand if you prefer to keep a record.
...
The current model is based on the data from California. Because of the difference of NBS project between different states and country, the model may not fit the data outside of California. Please contact [us](mailto:gang.peng@yale.edu) if you want to include model from your state or country. 
